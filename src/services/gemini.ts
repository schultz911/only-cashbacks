...
const EXHAUSTIVE_MERCHANT_MAPPINGS = [
  ...
  { pattern: /nykaa|mamaearth|sugar|plum|minimalist|wow|mcaffeine|dot ?& ?key|juicy chemistry|earth rhythm|moms co|beardo|bombay shaving|innovist|house of em5|nua/i, category: "Beauty", isOnline: true, isP2P: false },
  { pattern: /snapdeal|lenskart|firstcry|cliq|paytm|indiamart|shop101|glowroad|trell/i, category: "Shopping", isOnline: true, isP2P: false },
  ...
  { pattern: /boat|noise|candes|samsung|lg|voltas|godrej|intex|samtel|simmtronics|sterlite|foxconn|wistron/i, category: "Shopping", isOnline: true, isP2P: false },
  ...
  { pattern: /cleartrip|makemytrip|redbus|abhibus|mmt|yatra|goibibo|ixigo|agoda|booking\.com|booking|easemytrip|airbnb/i, category: "Travel", isOnline: true, isP2P: false },
  ...
  { pattern: /uber|ola|olacabs|rapido|namma yatri/i, category: "Commute", isOnline: true, isP2P: false },
  { pattern: /flight|airways|airlines|indigo|spicejet|air india|vistara|akasa/i, category: "Flights", isOnline: true, isP2P: false },
  { pattern: /hotel|resort|club mahindra|radisson|lemon tree|oyorooms|airbnb/i, category: "Hotel", isOnline: false, isP2P: false },
  ...
  { pattern: /google|google play|youtube premium|google storage/i, category: "App Store", isOnline: true, isP2P: false, platform: "Google Play" },
  ...
  { pattern: /bescom|bwssb|mahavitaran|mseb|adani electricity|tata power|cesc|electricity|power|jio|airtel|vi|vodafone|bsnl|mtnl|recharge|bill pay|telecom|dth|sun direct|tata play|tata sky|dish tv|water|water bill/i, category: "Utilities", isOnline: true, isP2P: false },
